...
* [Tree](#Tree)
    ...
    * [.isRoot(nodeOrKey)](#Tree+isRoot) ⇒ <code>boolean</code>
...
### @.isRoot(nodeOrKey) ⇒ <code>boolean</code>
<p>Checks if given node is the root.</p>
...
<p>Checks if given node is the last child.</p>
